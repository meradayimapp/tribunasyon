...
Route::get('/takim/{team}/puan-durumu', [TeamController::class, 'standings'])->name('teams.standings');
...
Route::get('/turnuva/{competition}', [CompetitionController::class, 'show'])->name('competitions.show');
Route::get('/turnuva/{competition}/state', [CompetitionController::class, 'state'])->name('competitions.state');
