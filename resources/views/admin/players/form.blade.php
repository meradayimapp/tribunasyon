...
<div class="panel-shell">
    ...
    <form class="surface" method="POST" enctype="multipart/form-data" action="{{ $player->exists ? route('admin.players.update', $player) : route('admin.players.store') }}">
        ...
        <div class="row g-4">
            ...
            <div class="col-md-5"><label class="form-label" for="nationality">Ülke / uyruk</label><input id="nationality" class="form-control" name="nationality" value="{{ old('nationality', $player->nationality) }}" maxlength="100"></div>
