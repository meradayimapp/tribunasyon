...
<div class="stat-grid">@foreach($stats as $label=>$value)<div class="stat"><strong>{{ number_format($value,0,',','.') }}</strong><span class="muted">{{ ['teams'=>'Takım','users'=>'Kullanıcı','moderators'=>'Moderatör','posts'=>'Yayınlanmış gönderi','comments'=>'Yorum'][$label] }}</span></div>@endforeach</div>
